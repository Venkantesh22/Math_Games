...
class SumEasyLevelScreen extends StatefulWidget {
  SumEasyLevelScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<SumEasyLevelScreen> createState() => _SumEasyLevelScreenState();
}

class _SumEasyLevelScreenState extends State<SumEasyLevelScreen> {
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.fromLTRB(5, 8, 20, 8),
                            child: Table(
                              // border:
                          ...
                          // diplayAnawer ? Get.to(() => SumEasyLevelScreen(),

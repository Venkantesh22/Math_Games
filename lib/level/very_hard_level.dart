...
class VeryHardLevelScreen extends StatefulWidget {
  VeryHardLevelScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<VeryHardLevelScreen> createState() => _VeryHardLevelScreenState();
}

class _VeryHardLevelScreenState extends State<VeryHardLevelScreen> {
// TextEditingController for Answer textField
  ...
  TextEditingController _thousandController = TextEditingController();
...
// TextEditingController for Answer textField
  ...
  TextEditingController _thousandCrayyController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    var thousndAnsField = _thousandController.text;

    var userAnswer =
        (thousndAnsField + hunderAnsField + tenAnsField + unitAnsField);
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(2, 8, 3, 8),
                          child: Table(
                            // border: TableBorder.all(color: Colors.black, width: 2),
                            columnWidths: const {
                              0: FlexColumnWidth(210),
                            ...
                            children: [
                              ...
                              TableRow(children: [
                                ...
                                Container(
                                    ...
                                    child: HeadTablecell('Th')),
                                Container(
                                    decoration:
                                        BoxDecoration(border: TBRSide()),
                              ...
                              TableRow(children: [
                                ...
                                Container(
                                  decoration: BoxDecoration(border: BLSide()),
                                  child: TextFields(
                                ...
                                Container(
                                  decoration: BoxDecoration(border: BRLSide()),
                                  child: TextFields(
                                    controller: _thousandCrayyController,
                                    unit: '0',
                                  ),
                                ),
                              ]),
                              ...
                              // Randow number generate Five row for up to down
                              TableRow(children: [
                                singSingnumberTableCell(),
                                GetBuilder<Controller>(
                                    builder: (controller2) => Container(
                              ...
                              // User answer Row Six row for up to down
                              TableRow(children: [
                                singHeadTablecell(),
                                Container(
                                  decoration: BoxDecoration(border: BRLSide()),
                                  child: TextFields(
                                    controller: _thousandController,
                                    unit: 'Th',
                                  ),
                                ),
                                Container(
                        ...
                        // diplayAnawer ? Get.to(() => VeryHardLevelScreen(),
